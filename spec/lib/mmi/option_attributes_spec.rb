RSpec.describe Mmi::OptionAttributes do
	...
	describe '#options' do
		...
		it 'cannot be set' do
			expect{test_instance_without_options.options = :some_other_test_symbol}.to raise_error NoMethodError, %r{#{Regexp.escape("undefined method `options=' for ")}}
		end
	end
	...
	describe '.opt_writer' do
		...
		describe 'the writer method' do
			it 'fails if options is not a hash' do
				expect{test_instance_without_options      .test_1 = 'goat'}.to raise_error NoMethodError, %r{#{Regexp.escape("undefined method `[]=' for nil:NilClass")}}
				expect{test_instance_with_non_hash_options.test_1 = 'goat'}.to raise_error NoMethodError, %r{#{Regexp.escape("undefined method `[]=' for 5:Integer"   )}}
				expect{test_instance_without_options      .test_2 = 'goat'}.to raise_error NoMethodError, %r{#{Regexp.escape("undefined method `[]=' for nil:NilClass")}}
				expect{test_instance_with_non_hash_options.test_2 = 'goat'}.to raise_error NoMethodError, %r{#{Regexp.escape("undefined method `[]=' for 5:Integer"   )}}
				expect{test_instance_without_options      .test_3 = 'goat'}.to raise_error NoMethodError, %r{#{Regexp.escape("undefined method `[]=' for nil:NilClass")}}
				expect{test_instance_with_non_hash_options.test_3 = 'goat'}.to raise_error NoMethodError, %r{#{Regexp.escape("undefined method `[]=' for 5:Integer"   )}}
				expect{test_instance_without_options      .test_4 = 'goat'}.to raise_error NoMethodError, %r{#{Regexp.escape("undefined method `[]=' for nil:NilClass")}}
				expect{test_instance_with_non_hash_options.test_4 = 'goat'}.to raise_error NoMethodError, %r{#{Regexp.escape("undefined method `[]=' for 5:Integer"   )}}
			end
	...
	describe '.opt_reader' do
		...
		describe 'the reader method' do
			it 'fails if options is not a hash' do
				expect{test_instance_without_options      .test_1}.to raise_error NoMethodError, %r{#{Regexp.escape("undefined method `[]' for nil:NilClass"       )}}
				expect{test_instance_with_non_hash_options.test_1}.to raise_error TypeError,     %r{#{Regexp.escape('no implicit conversion of String into Integer')}}
				expect{test_instance_without_options      .test_2}.to raise_error NoMethodError, %r{#{Regexp.escape("undefined method `[]' for nil:NilClass"       )}}
				expect{test_instance_with_non_hash_options.test_2}.to raise_error TypeError,     %r{#{Regexp.escape('no implicit conversion of String into Integer')}}
				expect{test_instance_without_options      .test_3}.to raise_error NoMethodError, %r{#{Regexp.escape("undefined method `[]' for nil:NilClass"       )}}
				expect{test_instance_with_non_hash_options.test_3}.to raise_error TypeError,     %r{#{Regexp.escape('no implicit conversion of String into Integer')}}
				expect{test_instance_without_options      .test_4}.to raise_error NoMethodError, %r{#{Regexp.escape("undefined method `[]' for nil:NilClass"       )}}
				expect{test_instance_with_non_hash_options.test_4}.to raise_error TypeError,     %r{#{Regexp.escape('no implicit conversion of String into Integer')}}
			end
